...
export default function Home() {
  ...
  const generateFastaFilename = (schemaName: string, version: number): string => {
    ...
    return `${schemaName}_v${version}_${timestamp}.fasta`;
  };
    ...
    <div className="min-h-screen p-8 pb-20 sm:p-20 font-sans">
      <main className="max-w-4xl mx-auto">
        ...
        <p className="mb-8 text-gray-600 dark:text-gray-400">
          Generate valid test data files (.tsv and .fasta) for testing uploads. There's no guarantee that this matches what would be generated by the Excel templates. All it does for each field is

          <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
            <li>Select a random value from picklist options</li>
            <li>Generate a random date for date fields</li>
            <li>Generate a random integer between 1 and 100 for integer/number fields</li>
            <li>Leave other_... fields blank</li>
            <li>Fill in "test value" for all other fields</li>
          </ul>

          Currently only a single sequence per fasta and a single line per tsv is generated. Each sequence gets a random 5-character suffix to ensure uniqueness.
        </p>
